...
public class ParkTest 
{
	 public static void main(String[] args) {
	        ...
	        AmusementPark amusementPark = new AmusementPark("Dream Park Evershine Paradise");
	        ...
	        while (continueShopping) {
	            ...
	            switch (choice) {
	                ...
	                case 6:
	                	...
	                	Vector<Ticket> bookedT = amusementPark.bookedTicket();
	                	if(bookedT.size()>0) {
	                ...
	                case 8:
	                	tickets= amusementPark.getTicket();
	                	if(tickets.size()>0) {
